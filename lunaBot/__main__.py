...
buttons = [
    [
        InlineKeyboardButton(text="➕ Add HwMusicBot To Your group ➕", url="http://t.me/HwMusicBot?startgroup=true"),
    ],
    [
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                     ...
                     InlineKeyboardButton(text="☎️ Support", url=f"https://t.me/HwBotSupport"),
                  ]
                ]
            ),
        )   
