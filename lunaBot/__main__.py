...
PM_START_TEXT = """
**hey I am ʜᴡ Robot** [ㅤ](https://telegra.ph/file/de94d33e9d5480714ac26.jpg)
️➖➖➖➖➖➖➖➖➖➖➖➖➖
...
buttons = [
    [
        InlineKeyboardButton(text="➕ ᴀᴅᴅ ʜᴡ ʙᴏᴛ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕", url="http://t.me/hwmusicbot?startgroup=true"),
    ],
    [
...
HELP_STRINGS = """
**Main commands:**  [ㅤ](https://telegra.ph/file/de94d33e9d5480714ac26.jpg)
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="https://t.me/HwMusicUpdates")]]
            ),
        )
...
def luna_about_callback(update, context):
    ...
    if query.data == "luna_":
        ...
        query.message.edit_text(
            ...
            f"4.) add @HwMusicAssistant to your group or type /join to invite her.\n"
        ...
        query.message.edit_text(
            text=f"<b> `Cʀᴇᴅɪᴛ Fᴏʀ ʜᴡ Dᴇᴠ's` </b>\n"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    ...
                    InlineKeyboardButton(text="BAZI", url="https://t.me/bazigaryt"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="luna_basichelp"),
        ...
        query.message.edit_text(
            text=f"｢ Setup Guide 」\n"
                 ...
                 f"\nIf you do need help with further instructions feel free to ask in @HwMusicUpdates.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            text=f"｢ Admin Permissions 」\n"
                     f"\nTo avoid slowing down, Hw caches admin rights for each user. This cache lasts about 10 minutes; this may change in the future. This means that if you promote a user manually (without using the /promote command), Hw will only find out ~10 minutes later.\n"
                    f"\nIf you want to update them immediately, you can use the /admincache or /reload command, that'll force Hw to check who the admins are again and their permissions\n"
                    f"\nIf you are getting a message saying:\nYou must be this chat administrator to perform this action!\n"
                    f"\nThis has nothing to do with Hw rights; this is all about YOUR permissions as an admin. Luna respects admin permissions; if you do not have the Ban Users permission as a telegram admin, you won't be able to ban users with Luna. Similarly, to change Hw settings, you need to have the Change group info permission.\n"
                    f"\nThe message very clearly states that you need these rights - not Hw.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1115486824 and DONATION_LINK:
            update.effective_message.reply_text(
